...
str(res, max.level = 1)
#> List of 7
#>  $ pval        : Named num [1:1316] 0.272 0.441 0.356 0.453 0.374 ...
#>   ..- attr(*, "names")= chr [1:1316] "AATF_CDKN1A" "AATF_MYC" "ABL1_BAX" "ABL1_CCND2" ...
#>  $ fdr         : Named num [1:1316] 0.551 0.619 0.585 0.622 0.591 ...
#>   ..- attr(*, "names")= chr [1:1316] "AATF_CDKN1A" "AATF_MYC" "ABL1_BAX" "ABL1_CCND2" ...
#>  $ edf         : Named num [1:1316] 18.06 13.67 18.59 6.25 15.61 ...
#>   ..- attr(*, "names")= chr [1:1316] "AATF_CDKN1A" "AATF_MYC" "ABL1_BAX" "ABL1_CCND2" ...
#>  $ res_local   : num [1:1316, 1:1747] 0.1184 0.075 0.0449 0.0554 0.0494 ...
#>   ..- attr(*, "dimnames")=List of 2
#>  $ res_local_pi:List of 1316
#>  $ residuals   : num [1:601, 1:1747] 0.395 0.264 0.472 0.833 0.512 ...
#>   ..- attr(*, "dimnames")=List of 2
#>  $ marginals   : num [1:601, 1:1747] -0.266 -0.6303 -0.0702 0.9656 0.0294 ...
#>   ..- attr(*, "dimnames")=List of 2
```
...
#> Number of gene pairs with significant SVC patterns (FDR < 0.05): 39
```
...
#> [5] ggplot2_4.0.1     spCorr_1.0.0.0000 BiocStyle_2.26.0 
#> 
