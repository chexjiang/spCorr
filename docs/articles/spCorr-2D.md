...
str(res, max.level = 1)
#> List of 7
#>  $ pval        : Named num [1:1316] 0.0939 0.1143 0.6792 0.2709 0.1266 ...
#>   ..- attr(*, "names")= chr [1:1316] "AATF_CDKN1A" "AATF_MYC" "ABL1_BAX" "ABL1_CCND2" ...
#>  $ fdr         : Named num [1:1316] 0.417 0.442 0.745 0.544 0.451 ...
#>   ..- attr(*, "names")= chr [1:1316] "AATF_CDKN1A" "AATF_MYC" "ABL1_BAX" "ABL1_CCND2" ...
#>  $ edf         : Named num [1:1316] 16.3 13.4 3 18.5 16.1 ...
#>   ..- attr(*, "names")= chr [1:1316] "AATF_CDKN1A" "AATF_MYC" "ABL1_BAX" "ABL1_CCND2" ...
#>  $ res_local   : num [1:1316, 1:1747] 0.0402 0.219 0.0017 -0.0557 -0.0639 ...
#>   ..- attr(*, "dimnames")=List of 2
#>  $ res_local_pi:List of 1316
#>  $ residuals   : num [1:601, 1:1747] 0.416 0.43 0.654 0.297 0.477 ...
#>   ..- attr(*, "dimnames")=List of 2
#>  $ marginals   : num [1:601, 1:1747] -0.2117 -0.1769 0.3957 -0.5319 -0.0571 ...
#>   ..- attr(*, "dimnames")=List of 2
```
...
#> Number of gene pairs with significant SVC patterns (FDR < 0.05): 46
```
