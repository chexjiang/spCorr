...
```{r p_corr, fig.width=9, fig.height=4, out.width='100%', fig.align='center'}
...
The **spCorr** also provides SVC testing to identify gene pairs whose correlations vary significantly across spatial locations. The BH-adjusted *p*-values from the SVC testing are stored in `res$fdr`.
